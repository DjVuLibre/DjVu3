...
//C-
//C- $Id: DjVuDumpHelper.h,v 1.1 2000-09-21 23:52:30 mrosen Exp $
...
/** @name DjVuDupmHelper.h
    ...
    @version
    #$Id: DjVuDumpHelper.h,v 1.1 2000-09-21 23:52:30 mrosen Exp $# */
//@{
...
public:
   ...
   ~DjVuDumpHelper(void) {}
	  ...
	  the results in \Ref{MemoryByteStream}. */
   GP<MemoryByteStream>	dump(const GP<DataPool> & pool);
      /** Interprets the file passed in the \Ref{ByteStream}, and returns
	  the results in \Ref{MemoryByteStream}. */
   GP<MemoryByteStream>	dump(ByteStream & str);
};
