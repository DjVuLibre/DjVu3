...
//
// $Id: djvused.cpp,v 1.5 2001-09-21 21:51:15 leonb Exp $
// $Name:  $
...
void
remove_meta(GP<ByteStream> in, GP<ByteStream> out)
{
  int c;
  int plevel = 0;
  bool copy = true;
...
{ 
  ...
  vprint("no chunk TXT found %ld",i);
  return 0;
}
