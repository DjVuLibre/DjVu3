...
//C-
//C- $Id: DataPool.h,v 1.1.1.1 1999-10-22 19:29:23 praveen Exp $
...
/** @name DataPool.h
    ...
    @version #$Id: DataPool.h,v 1.1.1.1 1999-10-22 19:29:23 praveen Exp $#
*/
...
private:
   ...
   public:
      ...
      Trigger(void) : start(0), length(-1), callback(0), cl_data(0) {};
