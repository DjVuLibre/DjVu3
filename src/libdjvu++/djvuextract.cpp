...
//C-
//C- $Id: djvuextract.cpp,v 1.14 1999-08-17 23:48:04 leonb Exp $
...
/** @name djvuextract
    ...
    @version
    #$Id: djvuextract.cpp,v 1.14 1999-08-17 23:48:04 leonb Exp $#
    @author
...
{
  GP<DjVuDocument> doc=new DjVuDocument(GOS::filename_to_url(filename));
