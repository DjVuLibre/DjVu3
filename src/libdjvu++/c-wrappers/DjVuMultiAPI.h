 ...
 *C-
 *C- $Id: DjVuMultiAPI.h,v 1.26 2000-09-18 17:10:36 bcr Exp $
 */
 ...
 * Revision 1.26  2000-09-18 17:10:36  bcr
 * Adding files.
 *
 * Revision 1.24.12.1  2000/08/11 01:13:25  bcr
 * Added support for Expervisions RTK into linux builds.
 *
 * Revision 1.24  2000/07/11 19:28:54  bcr
...
struct djvu_combine_options_struct
{
  ...
  */
  ...
  /** OCR.
        This value should be 1 if the document should be OCR'ed, and 
        zero if the document should not be OCR'ed.  All other values are
