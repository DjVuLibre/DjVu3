 ...
 *C-
 *C- $Id: DjVuDocumentAPI.h,v 1.33 2000-09-18 17:10:35 bcr Exp $
 */
 ...
 * Revision 1.33  2000-09-18 17:10:35  bcr
 * Adding files.
 *
 * Revision 1.31.12.1  2000/08/07 19:45:25  bcr
 * Restoring changes I accidently removed.
 *
 * Revision 1.31  2000/07/11 19:28:54  bcr
...
/** ++ #djvuforeground_type_enum# defines what format of JB2 will be
     used for the foreground.  Possible values consist of bitonal,
     color, and none.
*/
enum djvuforeground_type_enum
{
  djvu_bitonal_jb2=0, /* bitonal in the JB2Matcher */
  djvu_color_jb2=1, /* paletted in the JB2Matcher */
  djvu_no_jb2 /* Do not use a foreground layer at all. */
};

typedef enum djvuforeground_type_enum djvuforeground_type;
...
{ 
  ...
  /** Foreground colors are coded as as specified in the JB2Matcher */
  djvuforeground_type jb2_format;
...
djvu_foreground_options_struct::djvu_foreground_options_struct() :
  jb2_format(djvu_bitonal_jb2), quality(75)
{};
